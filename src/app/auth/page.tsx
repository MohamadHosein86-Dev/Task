    ...
    <div className={styles.container}>
      <div className={styles.authCard}>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          <Input label="شماره تلفن" name="phoneNumber" type="tel" placeholder="09123456789" value={phoneNumber} onChange={handlePhoneChange} onBlur={handlePhoneBlur} error={errors.phoneNumber} dir="ltr" className={styles.phoneInput} maxLength={11} />

          <Button type="submit" loading={isLoading} disabled={!!errors.phoneNumber || phoneNumber.length === 0} className={styles.submitButton}>
            ورود
          </Button>
        </form>
      </div>
